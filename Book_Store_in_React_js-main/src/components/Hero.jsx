    ...
    <div className="h-screen w-full bg-pink-50">
        ...
        <main className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-[50%] flex flex-col  lg:py-48 lg:px-20 p-14 duration-300">
                ...
                <h1 className="font-bold text-3xl">I'm <span className="text-red-500">Jeeban Jyoti Parida</span> <span className="font-semibold text-2xl text-green-400"> web Devloper</span></h1>
